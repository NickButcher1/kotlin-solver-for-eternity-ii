...
/**
 * A scanrow path for the full 16x16 board.
 * - 11 full rows left to right, starting from the top row.
 * - Then down five on each column, left to right.
 */
object Scanrow11BacktrackerPath : BacktrackerPath(
    listOf(
        ...
        178, 183, 188, 193, 198, 203, 208, 213, 218, 223, 228, 233, 238, 243, 248, 253,
